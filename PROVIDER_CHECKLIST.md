...
The [provider-jelly](https://github.com/crossplane/provider-jelly) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-jelly](https://github.com/crossplane-contrib/provider-jet-jelly) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-jelly/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-jelly/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-jelly/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-jelly/blob/main/hack/boilerplate.go.txt)
...
The [provider-jelly](https://github.com/crossplane/provider-jelly)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-jelly/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-jelly/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue jellys (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-jelly/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request jellys: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-jelly/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
